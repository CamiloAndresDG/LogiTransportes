 ...
 */
public class TrabajadoresJPanel extends javax.swing.JPanel {
    ...
    private Conductores conductorEncontrado = null;
//    Licencias licenciaEncontrada = null;

    /**
     * Creates new form TrabajadoresJPanel
     */
    public TrabajadoresJPanel(Principal principal) {
    ...
    private void initComponents() {
        ...
        jTextFieldVabCargoFecha = new javax.swing.JTextField();
        jLabelTextVabCargoFecha = new javax.swing.JLabel();
        ...
        jRadioButtonConductores = new javax.swing.JRadioButton();
        jSeparator1 = new javax.swing.JSeparator();
        jLabelBuscar = new javax.swing.JLabel();
        jRadioButtonAdmins = new javax.swing.JRadioButton();
        ...
        jLabelBotonAgregarEntrega.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabelBotonAgregarEntregaMouseClicked(evt);
            }
        });
        jPanel5.add(jLabelBotonAgregarEntrega, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, 150, 50));

        jLabelTextAgregarEntrega.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelTextAgregarEntrega.setText("Agregar nuevo trabajador");
        jPanel5.add(jLabelTextAgregarEntrega, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 420, -1, -1));
        ...
        jTableDatosEntregas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CEDULA", "NOMBRES", "DIRECCION RESIDENCIA", "NUM DE CONTACTO ", "ESTADO "
            }
        ) {
        ...
        jLabelTextNombres.setText("Nom completo:");
        ...
        jPanelInfoEncontrada.add(jLabelTextCelular, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 100, -1));

        jTextFieldEstado.setBackground(new java.awt.Color(240, 240, 240));
        jTextFieldEstado.setBorder(null);
        jPanelInfoEncontrada.add(jTextFieldEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 190, 20));
        ...
        jPanelInfoEncontrada.add(jLabelTextEstado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 100, -1));
        ...
        jPanelInfoEncontrada.add(jLabelTextCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, 100, 30));
        ...
        jTextFieldVabCargoFecha.setEditable(false);
        jTextFieldVabCargoFecha.setBorder(null);
        jPanelInfoEncontrada.add(jTextFieldVabCargoFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 210, 190, 20));

        jLabelTextVabCargoFecha.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabelTextVabCargoFecha.setForeground(new java.awt.Color(0, 50, 168));
        jLabelTextVabCargoFecha.setText(" ");
        jPanelInfoEncontrada.add(jLabelTextVabCargoFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 210, 100, -1));
        ...
        jLabelTextInfoDelConductor.setText("Info. de la licencia");
        ...
        jLabelTextModificarEntrega.setText("Modificar datos persona");
        ...
        jLabelTextInfoEntregas.setText("Información de las trabajadores");
        ...
        jRadioButtonConductores.setBackground(new java.awt.Color(207, 216, 220));
        jRadioButtonConductores.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioButtonConductores.setText("Conductores");
        jRadioButtonConductores.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButtonConductoresActionPerformed(evt);
            }
        });
        jPanelBusqueda.add(jRadioButtonConductores, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 90, -1, -1));
        ...
        jRadioButtonAdmins.setBackground(new java.awt.Color(207, 216, 220));
        jRadioButtonAdmins.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jRadioButtonAdmins.setText("Administrativos");
        jRadioButtonAdmins.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jRadioButtonAdminsActionPerformed(evt);
            }
        });
        jPanelBusqueda.add(jRadioButtonAdmins, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 90, -1, -1));
...
//        principal.volverAInicioTrabajador(this);        // TODO add your handling code here:
    ...
    private void jLabelBotonConductorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBotonConductorMouseClicked
        if (conductorEncontrado != null) {
            conductorEncontrado = principal.fachadaTrabajador.buscarConductor(trabajadorEncontrado.getIdentificacion().getIdentificacion());
            JOptionPane.showMessageDialog(null, "Licencia\n"
                    + "N° de licencia: " + conductorEncontrado.getNumeroLicencia().getNumeroLicencia()
                    + "\nFecha de vencimiento: " + conductorEncontrado.getNumeroLicencia().getVigencia()
                    + "\nCategorias: " + conductorEncontrado.getNumeroLicencia().getCategorias()
            );
        } else {
            JOptionPane.showMessageDialog(null, "La persona que ha seleccionado no tiene licencia de conducción.");
        }
    ...
    private void jLabelBotonInfoEmpresaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBotonInfoEmpresaMouseClicked
        JOptionPane.showMessageDialog(null, "Info de contacto\n"
                + "Num de contacto (Celular): " + trabajadorEncontrado.getIdentificacion().getCelularContacto()
                + "\nNum de contacto (Telefono): " + trabajadorEncontrado.getIdentificacion().getTelefonoContacto()
                + "\nCONTACTO DE REFERENCIA: "
                + "\nNombres del contacto: " + trabajadorEncontrado.getNombreReferenciaFamiliar()
                + "\nNum de contacto (Celular): " + trabajadorEncontrado.getNumeroReferenciaFamiliar()
        );
...
//        }
    ...
    private void jRadioButtonConductoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonConductoresActionPerformed
//        if (jRadioButtonTodos.isSelected()) {
//            jRadioButtonAdmins.setSelected(false);
//            jRadioButtonConductores.setSelected(false);
//            actualizarListaTrabajadoresTODOS();
////        } else if (jRadioButtonAdmins.isSelected()) {
//            jRadioButtonTodos.setSelected(false);
//            jRadioButtonConductores.setSelected(false);
//            actualizarListaTrabajadoresADMINISTRATIVOS();
//        } else if (jRadioButtonConductores.isSelected()) {
        jRadioButtonTodos.setSelected(false);
        jRadioButtonAdmins.setSelected(false);
        actualizarListaTrabajadoresCONDUCTORES();
//        }
    }//GEN-LAST:event_jRadioButtonConductoresActionPerformed
    ...
    private void jLabelBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBuscarMouseClicked
        ...
        if (datoABuscar.equalsIgnoreCase("") || datoABuscar.equalsIgnoreCase(" ")) {
            ...
            Trabajadores trabajadorHallado = principal.fachadaTrabajador.buscarTrabajador(datoABuscar);
            if (trabajadorHallado != null) {
                actualizarListaAdministrativos(trabajadorHallado);
            } else {
                JOptionPane.showMessageDialog(null, "No se encontro la persona con la identificacion " + datoABuscar + ".");
            }
        }
    ...
    private void jRadioButtonAdminsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButtonAdminsActionPerformed
//        if (jRadioButtonTodos.isSelected()) {
//            jRadioButtonAdmins.setSelected(false);
//            jRadioButtonConductores.setSelected(false);
//            actualizarListaTrabajadoresTODOS();
...
//            actualizarListaTrabajadoresCONDUCTORES();
//        }
    }//GEN-LAST:event_jRadioButtonAdminsActionPerformed

    private void jLabelBotonAgregarEntregaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBotonAgregarEntregaMouseClicked
        principal.irAAgregarNuevoTrabajador();        // TODO add your handling code here:
    }//GEN-LAST:event_jLabelBotonAgregarEntregaMouseClicked
    ...
    private javax.swing.JLabel jLabelTextVabCargoFecha;
    ...
    private javax.swing.JRadioButton jRadioButtonAdmins;
    private javax.swing.JRadioButton jRadioButtonConductores;
    ...
    private javax.swing.JTextField jTextFieldVabCargoFecha;
    // End of variables declaration//GEN-END:variables

    private void actualizarListaTrabajadoresTODOS() {
        List<Trabajadores> lc = principal.fachadaTrabajador.listaTrabajadores();
        imprimirEnTablaTrabajadores(lc);
    }

    private void actualizarListaTrabajadoresCONDUCTORES() {
        List<Conductores> lc = principal.fachadaTrabajador.listaConductores();
        List<Trabajadores> lcTrabajadores = principal.fachadaTrabajador.listaTrabajadores();
        imprimirEnTablaConductores(lc, lcTrabajadores);
    }

    private void actualizarListaTrabajadoresADMINISTRATIVOS() {
        List<Administrativos> lc = principal.fachadaTrabajador.listaAdministrativos();
        imprimirEnTablaAdministrativos(lc);
    }
    ...
    private void obtenerDatosSeleccionado() {
        ...
        if (jTableDatosEntregas.getSelectedRow() != -1) {
            //Obtiene cedula
            String identificacion = (String) modeloTabla.getValueAt(jTableDatosEntregas.getSelectedRow(), 0);

            //Se busca la cedula en la base de datos
            trabajadorEncontrado = principal.fachadaTrabajador.buscarTrabajador(identificacion);
            conductorEncontrado = principal.fachadaTrabajador.buscarConductor(identificacion);

            jTextFieldCedula.setText(String.valueOf(trabajadorEncontrado.getIdentificacion().getIdentificacion()));
            jTextFieldNombres.setText(String.valueOf(trabajadorEncontrado.getIdentificacion().getNombres() + " " + trabajadorEncontrado.getIdentificacion().getApellidos()));
            jTextFieldCelular.setText(String.valueOf(trabajadorEncontrado.getIdentificacion().getCelularContacto()));
            if (principal.administrativo != null) {
                jTextFieldEstado.setText(trabajadorEncontrado.getEstado());
                jLabelTextVabCargoFecha.setText("Cargo: ");
                jTextFieldVabCargoFecha.setText(principal.administrativo.getCargo());
            } else {
                jTextFieldEstado.setText(trabajadorEncontrado.getEstado());
                jLabelTextVabCargoFecha.setText("Ultimo viaje: ");
                jTextFieldVabCargoFecha.setText(principal.fachadaTrabajador.buscarConductor(identificacion).getFechaUltimoViaje().toString());
            }
        } else {
    ...
    private void actualizarListaBuscado(Trabajadores trabajadorHallado) {
        ...
        String[] d = {trabajadorHallado.getIdentificacion().getIdentificacion(),
    ...
    private void imprimirEnTablaTrabajadores(List<Trabajadores> listaDeTrabajadores) {
        if (!listaDeTrabajadores.isEmpty()) {
            modeloTabla.setRowCount(0);
            for (int i = 0; i < listaDeTrabajadores.size(); i++) {
                Trabajadores aux = listaDeTrabajadores.get(i);
                String[] d = {
                    aux.getIdentificacion().getIdentificacion(),
                    aux.getIdentificacion().getNombres() + " " + aux.getIdentificacion().getApellidos(),
                    aux.getDireccionResidencia(),
                    aux.getIdentificacion().getCelularContacto().toString(),
                    aux.getEstado() + ""
                };
                modeloTabla.addRow(d);
            }
    ...
    private void imprimirEnTablaAdministrativos(List<Administrativos> listaDeTrabajadores) {
        if (!listaDeTrabajadores.isEmpty()) {
            modeloTabla.setRowCount(0);
            for (int i = 0; i < listaDeTrabajadores.size(); i++) {
                Administrativos aux = listaDeTrabajadores.get(i);
                String[] d = {
                    aux.getIdentificacion().getIdentificacion(),
                    aux.getCargo()
                };
    ...
    private void imprimirEnTablaConductores(List<Conductores> listaDeConductores, List<Trabajadores> listaDeTrabajadores) {
        if (!listaDeConductores.isEmpty()) {
            modeloTabla.setRowCount(0);
            for (int i = 0; i < listaDeTrabajadores.size(); i++) {
                for (Conductores listaDeConductore : listaDeConductores) {
                    Conductores aux = listaDeConductores.get(i);
                    Trabajadores aux2 = listaDeTrabajadores.get(i);
                    if (aux.getIdentificacion().equals(aux2.getIdentificacion())) {
                        String[] d = {
                            aux.getIdentificacion().getIdentificacion(),
                            aux.getIdentificacion().getNombres() + " " + aux.getIdentificacion().getApellidos()
                        };
    ...
    private void actualizarListaAdministrativos(Trabajadores trabajadorHallado) {
        modeloTabla.setRowCount(0);
        String[] d = {trabajadorHallado.getIdentificacion().getIdentificacion()};
        modeloTabla.addRow(d);
    }
